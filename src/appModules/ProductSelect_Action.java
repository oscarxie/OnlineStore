...
public class ProductSelect_Action {
  ...
  public static void productType(int iTestCaseRow) throws Exception {
    try {
      ...
      // iTestcaseRow is the row number of our Testcase name in the Test Data sheet
      // Constant.Col_ProductType is the column number for Product Type column in the Test Data
      // sheet
      ...
      // If condition will check that if the Excel value for the Product Type is Accessories, then
      // do this
      ...
      // I am just catching the Exception and again throwing it back to the Main testcase, without
      // handling it
  ...
  public static void productNumber(int iTestCaseRow) throws Exception {
    try {
      ...
      // iTestcaseRow is the row number of our Testcase name in the Test Data sheet
      // Constant.Col_ProductNumber is the column number for Product Number column in the Test Data
      // sheet
      // Please see the Constant class in the Utility Package
      // For Use of Constant Variables, please see http://www.toolsqa.com/constant-variables/
      // If condition will check that if the Excel value for the Product Number is "Product 1", then
      // do this
