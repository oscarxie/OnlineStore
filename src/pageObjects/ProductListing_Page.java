  ...
  public static class Product_1 {
    ...
    public static WebElement txt_Price() {
      ...
      try {
        element =
            driver
                .findElement(By
                    .xpath(".//*[@id='default_products_page_container']/div[3]/div[2]/form/div[1]/p[1]/span[2]"));
      ...
      try {
        element =
            driver.findElement(By
                .xpath(".//*[@id='default_products_page_container']/div[3]/div[1]/a"));
    ...
    public static WebElement txt_Name() throws Exception {
      ...
      try {
        element =
            driver.findElement(By
                .xpath(".//*[@id='default_products_page_container']/div[3]/div[2]/h2"));
    ...
    public static WebElement btn_AddToCart() {
      ...
      try {
        element =
            driver
                .findElement(By
                    .xpath(".//*[@id='default_products_page_container']/div[3]/div[2]/form/div[2]/div[1]/span/input"));
  ...
  public static class Product_2 {
    ...
    public static WebElement txt_Price() {
      ...
      try {
        element =
            driver
                .findElement(By
                    .xpath(".//*[@id='default_products_page_container']/div[4]/div[2]/form/div[1]/p[1]/span[2]"));
    ...
    public static WebElement img_Product() {
      ...
      try {
        element =
            driver.findElement(By
                .xpath(".//*[@id='default_products_page_container']/div[4]/div[1]/a"));
    ...
    public static WebElement btn_AddToCart() {
      ...
      try {
        element =
            driver
                .findElement(By
                    .xpath(".//*[@id='default_products_page_container']/div[4]/div[2]/form/div[2]/div[1]/span/input"));
